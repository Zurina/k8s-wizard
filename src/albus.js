										...
										<Step
											...
											render={({ push }) => (
												<div>
													...
													<h3>
														If you can say yes to the following, then yes:
													</h3>
													<ul>
														<li>Do you operate many different applications?</li>
														<li>
															Are they containerized or do you plan to
															containerize them?
														</li>
														<li>
															Have you ruled out the Container as a Service
															options (Cloud run, Apprunner, Fargatte and so
															on)?
														</li>
													</ul>
													<p>
														So in the end, it comes down to whether you are
														operating many, containerized, microservices k8s can
														provide a great base for building an app platform.
										...
										<Step
											...
											render={({ push }) => (
												<div>
													...
													<button onClick={() => push("introduction")}>
														Regret?
													</button>
												</div>
											)}
										...
										<Step
											...
											render={({ push }) => (
												<div>
													...
													<ul>
														<li>
															Do you need new features as soon as they are
															released?
														</li>
														<li>
															Are you required to run on-premise for some
															reason?
														</li>
														<li>
															Are you prepared and skilled enought to deal with
															and debug issues with the control pane should they
															arise?
														</li>
													</ul>
													<button
										...
										<Step
											...
											render={({ push }) => (
												<div>
													...
													<p>
														These all come with different levels of automation
														and control integrated. Some include provisioning
														the underlying infrastructure while others doesn't.
													</p>
													...
													<button
														onClick={() => push("infrastructure-as-code")}
													>
														Next
													</button>
												</div>
										...
										<Step
											...
											render={({ push }) => (
												<div>
													...
													<h3>
														There are a lot of options. It comes down to your
														needs and maybe the cloud you're already using.
													</h3>
													<p>
														In addition to the Kubernetes service you also need
														to consider and think about other services that the
														provider can offer and you'd like to use. This could
														be regarding storage types, DB as as Service, IAM an
														so on.
													</p>
